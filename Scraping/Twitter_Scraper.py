...
class TwitterScraper:
            ...
            for tweet in tweets:
                try:
                    ...
                    try:
                        ...
                        # /html/body/div[1]/div/div/div[2]/main/div/div/div/div/div/div[3]/div/div/section/div/div/div[10]/div/div/article/div/div/div[2]/div[2]/div[4]/div/div[1]/div/div/div[2]/span/span/span
    ...
    def login(self,email,acc,password):
        self.driver.get("https://twitter.com/i/flow/login")
        self.wait()

        self.driver.find_element_by_xpath("//input[@autocomplete='username']").send_keys(email)
        ...
        try:
            self.driver.find_element_by_xpath('//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[2]/label/div/div[2]/div/input').send_keys(acc)
...
if __name__ == "__main__":
    ...
    scraper.login(email,acc,password)
    scroll_time = 150
    ...
    scraper.save_to_excel('D:/scrap_tw_{today}.xlsx')
